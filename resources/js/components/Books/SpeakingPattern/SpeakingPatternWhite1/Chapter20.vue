...
<v-container fluid ma-0 pa-0>
  ...
  <v-layout column>
    <v-img
        ...
        black--text
      >
     <h1 class="upper-header-SPW1">Do you know if…?  ~인지 아닌지 아니? 
  </h1>
      </v-layout>
    </v-img>


          <h2 class="lower-header-SPW1">Today's topic</h2>
...
<h2  class = "border-SPW1">Pattern Practice
</h2>
