...
<v-container fluid ma-0 pa-0>
  ...
  <v-layout column>
    <v-img
        ...
        black--text
      >
     <h1 class="upper-header-SPG3">우리 ~해야 할지도 모르겠어
  </h1>
      </v-layout>
    </v-img>


          <h2 class="lower-header-SPG3">Today's topic</h2>
...
<h2  class = "border-SPG3">Pattern Practice
</h2>
