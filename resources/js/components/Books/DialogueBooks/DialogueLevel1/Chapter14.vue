<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://image.freepik.com/free-photo/portrait-beautiful-cheerful-redhead-woman-with-flying-curly-hair-smiling-laughing_176420-14460.jpg" class="cover-photo">
